...
assert(indexHtml.includes('class="implications"') && indexHtml.includes('Feature-label mismatch') && indexHtml.includes('Output hallucination'), "Implications section should tie the feature-label mismatch to LLM hallucination with a two-card comparison.");
assert(indexHtml.indexOf('class="implications"') > indexHtml.indexOf('class="takeaway-snapshot"') && indexHtml.indexOf('class="implications"') < indexHtml.indexOf('id="project-note"'), "Implications section should sit between the takeaway proof and the design note.");
